...
public class JobIntentService {
    ...
    public void save(JobIntent jobIntent) {
        String sql = "create table if not exists jobintention(id integer primary key autoincrement,username varchar(20),workplace varchar(20),tradecategory varchar(20),positioncategory varchar(20),salary varchar(20))";
