...
public class SendRecordPage extends BaseActivity implements View.OnClickListener {
    ...
    private static String url_view = "http://10.0.3.2:63342/htdocs/db/seeker_send_record_view.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_record_page);

        SharedPreferences sharedPreferences = getSharedPreferences("userinfo", MODE_PRIVATE);
        username = sharedPreferences.getString("username", "");

        backBtn = (Button) findViewById(R.id.back_button_mr);
        positionLv = (ListView) findViewById(R.id.my_record_lv);
        ...
        positionLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SendRecordPage.this, PositionDetailPage.class);
    ...
    class LoadMyCollection extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SendRecordPage.this);
